...
class Api_2Platform extends FlutterRustBridgeBase<Api_2Wire> {
  Api_2Platform(ffi.DynamicLibrary dylib) : super(Api_2Wire(dylib));
// Section: api2wire
...
class Api_2Wire implements FlutterRustBridgeWireBase {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Api_2Wire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Api_2Wire.fromLookup(
  ...
  void wire_test_print_2(
    int port_,
    ffi.Pointer<wire_uint_8_list> log,
  ) {
    return _wire_test_print_2(
      port_,
      log,
    );
  }

  late final _wire_test_print_2Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>('wire_test_print_2');
  late final _wire_test_print_2 = _wire_test_print_2Ptr
